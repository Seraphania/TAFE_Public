...
- Inheritance:
  > Attributes  and behaviours from one object are inherited by another.
- Encapsulation:
  > Protecting the parts of code from being accessed externally.
- Abstraction:
  > Using the function of an object by referring to it and what it does, rather than how it is implemented.
- Polymorphism:
  > Being able to re-use nad modify what code does in different situations.
